...
・Correction of logical errors in the project overview diagram I have created
<br>・Identifying the causes of coding errors and proposing solutions.
...
<br>・Writing logic comments within the code
## comment
...
<br>As I focused my studies on Solidity, I wrote most of my code for smart contracts.
For other languages, such as TypeScript, I relied heavily on AI assistance. Although I was unable to code everything myself, I managed to complete the project with the help of AI-assisted coding and by learning as I went along.
